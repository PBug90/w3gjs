...
Player.prototype.trackGameEntity = function (actionType, actionId) {
  if (!this.detectedRace && typeof actionId === 'string') {
    if (actionId.startsWith('e')) { this.detectedRace = 'N' } else if (actionId.startsWith('o')) { this.detectedRace = 'O' } else if (actionId.startsWith('h')) { this.detectedRace = 'H' } else if (actionId.startsWith('u')) { this.detectedRace = 'U' }
  }
